...
const POSTS = [
  {
    ...
    excerpt:
      'Ransomware attacks on government and healthcare institutions have surged globally. We break down the tactics used and how Gasha Antivirus\'s behavioral engine stops them before encryption begins.',
    date: 'April 10, 2025',
    readTime: '5 min read',
    image: '/av.png',
  ...
  },
  {
    ...
    excerpt:
      'SQL injection and cross-site scripting remain the top attack vectors against public-facing web applications. Learn how Gasha WAF\'s rule engine provides real-time protection without impacting performance.',
    date: 'March 28, 2025',
    readTime: '4 min read',
    image: '/waf.png',
  ...
  },
  {
    ...
    excerpt:
      'The perimeter-based security model is obsolete. Discover how Enyuma IAM\'s zero-trust approach — verify every user, every device, every time — reduces insider threats and lateral movement.',
    date: 'March 14, 2025',
    readTime: '6 min read',
  ...
  return (
    <section className="py-20 px-4 sm:px-6" style={{ background: 'var(--bg-secondary)' }} aria-labelledby="blog-heading">
      <div className="mx-auto max-w-7xl">
        ...
        >
          <p className="mb-2 text-xs font-semibold uppercase tracking-widest text-[var(--accent-cyan)]">Security Insights</p>
          ...
          <p className="mt-3 text-[var(--text-muted)] max-w-xl mx-auto text-sm">
            Expert analysis, threat intelligence, and best practices from Ethiopia's national cybersecurity authority.
          </p>
        </motion.div>
            ...
            return (
              ...
              >
                ...
                <Link href={`/blog/${post.slug}`} className="block relative h-44 overflow-hidden" tabIndex={-1}>
                  ...
                  {/* Category badge */}
                  <div
                    className="absolute top-3 left-3 flex items-center gap-1.5 rounded-full px-2.5 py-1 text-[10px] font-bold text-white"
                ...
                <div className="flex flex-col flex-1 p-5">
                  ...
                  {/* Excerpt */}
                  <p className="text-xs text-[var(--text-muted)] leading-relaxed flex-1 mb-4 line-clamp-3">
                    {post.excerpt}
                  </p>
